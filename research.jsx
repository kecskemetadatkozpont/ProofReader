    ...
    return h('div', { className: 'rv-scrim', onClick: props.onClose },
      h('div', { className: 'rv-shell', onClick: function (e) { e.stopPropagation(); } },
        h('div', { className: 'rv-bar' },
          h('b', { style: { flex: '1 1 130px', minWidth: 130, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' } }, props.title || 'Report'),
          props.onSave ? h('button', { className: 'btn', style: { padding: '4px 10px', fontSize: 12, flex: 'none' }, disabled: saved === 'saving', title: 'Save this consolidated report into the project files (Ideas → Files)', onClick: save }, saved === 'done' ? '✓ Saved' : (saved === 'saving' ? '💾…' : '💾 Save')) : null,
