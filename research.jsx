        ...
        steps.length ? steps.map(function (s, i) {
          ...
          return h('div', { key: s.id, style: { borderBottom: '1px solid var(--soft)', padding: '8px 0' } },
            ...
            open ? h('div', { style: { margin: '6px 0 2px 28px', fontSize: 12.5, color: 'var(--muted)', lineHeight: 1.5 } },
              ...
              (s.result && s.result.summary) ? h('div', { style: { marginTop: 6, fontSize: 12.5, color: 'var(--ink)', lineHeight: 1.5 } }, s.result.summary) : null,
              (s.result && s.result.adaptation) ? h('div', { style: { marginTop: 4, fontSize: 11.5, color: 'var(--warn)' } }, '⚙ ' + s.result.adaptation) : null,
              (s.result && s.result.error) ? h('div', { style: { marginTop: 4, color: 'var(--danger)' } }, '⚠ ' + s.result.error) : null,
              (s.result && s.result.metrics) ? h('pre', { style: { marginTop: 6, fontFamily: 'monospace', fontSize: 11, background: 'var(--soft)', padding: '6px 8px', borderRadius: 6, overflow: 'auto', whiteSpace: 'pre-wrap', wordBreak: 'break-word', maxHeight: 220 } }, JSON.stringify(s.result.metrics, null, 1)) : null,
