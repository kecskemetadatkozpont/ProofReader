...
- [ ] ⏳ **P2** — dock „💡 ötlet a beszélgetésből" (`suggestIdeas`) + kijelölés→ötlet · böngésző-törlés/átnevezés is bumpolja a térképet · natív `window.PRFigureBoard`/… (ha az iframe kevés).
