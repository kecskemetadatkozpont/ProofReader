...
function notifTarget(n) { const p = n.payload || {}; if (n.kind === 'share' && p.project_id) return 'ProofReader.html?p=' + p.project_id; if (n.kind === 'job' && p.project_id) return 'Research.html?project=' + p.project_id; if (p.href) return p.href; return null; }
